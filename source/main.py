...
parser.add_argument("--weights", "-w ", help = "Archivo con los pesos del modelo")
...
if args.preprocess:
    ...
    # Grafica Accuracy
    pltResults(config, history.history['acc'], history.history['val_acc'], 'Model accuracy', 'epoch', 'accuracy')

    # Grafica Loss 
    pltResults(config, history.history['loss'], history.history['val_loss'], 'Model loss', 'epoch', 'loss')
